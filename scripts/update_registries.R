...
known_species_map <- list(
  ...
  list(pattern = "brachypodium|bdistachyon|stiff[_ -]?brome", organism = "Brachypodium distachyon", taxid = 15368L, aliases = c("brachypodium", "stiff brome", "Bd21")),
...
known_species_taxid_map <- list(
  ...
  list(taxid = 15368L, organism = "Brachypodium distachyon", kingdom = "Plantae", aliases = c("brachypodium", "stiff brome", "Bd21")),
