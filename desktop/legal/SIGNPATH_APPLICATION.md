...
This document is the prepared application packet for CGeV Desktop. Do not submit it until every readiness item below is public and verifiable.

## Readiness gate

- [x] The project uses the OSI-approved MIT License.
- [x] CGeV Desktop has a public privacy policy, third-party notices, and code signing policy prepared in the source tree.
...
- [x] The download experience documents CGeV Desktop features and supported platforms.
...
- [ ] Publish at least one CGeV Desktop release in the form offered to users. SignPath Foundation currently requires the project to be released before applying.
...
- **Exact source:** OpenAI Codex recommendation while preparing CGeV Desktop release signing.
