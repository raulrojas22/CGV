...
async function startShiny() {
  ...
  const env = {
    ...
    APP_HOMO_INITIAL_VISIBLE: process.env.APP_HOMO_INITIAL_VISIBLE || "64",
    APP_ORTHO_INITIAL_VISIBLE: process.env.APP_ORTHO_INITIAL_VISIBLE || "64",
    ...
    APP_ORTHO_RENDER_CHUNK_SIZE: process.env.APP_ORTHO_RENDER_CHUNK_SIZE || "64",
    APP_ORTHO_AUTO_RENDER_MORE: process.env.APP_ORTHO_AUTO_RENDER_MORE || "0",
    APP_ORTHO_AUTO_RENDER_DELAY_MS: process.env.APP_ORTHO_AUTO_RENDER_DELAY_MS || "0",
