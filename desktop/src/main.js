...
async function startShiny() {
  ...
  const env = {
    ...
    APP_ORTHO_RENDER_CHUNK_SIZE: process.env.APP_ORTHO_RENDER_CHUNK_SIZE || "2",
    APP_ORTHO_AUTO_RENDER_MORE: process.env.APP_ORTHO_AUTO_RENDER_MORE || "1",
    APP_ORTHO_AUTO_RENDER_DELAY_MS: process.env.APP_ORTHO_AUTO_RENDER_DELAY_MS || "250",
    ...
    APP_HOMO_DEFER_SEQUENCE: process.env.APP_HOMO_DEFER_SEQUENCE || "1",
    APP_ORTHO_DEFER_SEQUENCE: process.env.APP_ORTHO_DEFER_SEQUENCE || "1",
    APP_FOOTER_DEFER_SEQUENCE: process.env.APP_FOOTER_DEFER_SEQUENCE || "1",
    APP_DEFER_FEATURE_GC: process.env.APP_DEFER_FEATURE_GC || "1",
